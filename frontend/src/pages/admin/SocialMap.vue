    ...
    <table class="va-table va-table--hoverable">
      ...
      <tbody>
        <tr v-for="user in sortedUsers" :key="user.id">
          <td><pre>{{ user.discord_user_id }}</pre></td>
          <td>
          ...
          <td style="border-left: 2px solid #333333; text-align: right"><pre>{{ user.id }}</pre></td>
          <td style="text-align: left">
            <VaButton :href="'https://twitch.tv/' + user.login" 
            round 
            size="small" 
            color="#000000"
          ...
          <td style="border-left: 2px solid #333333">
            <VaButton v-if="user.bluesky_username"
              :href="'https://bsky.app/profile/' + user.bluesky_username"
              target="_blank"
              color="#000000"
              borderColor="blueskyBlue"
              size="small"
              outline
              round>
          ...
          <td style="border-left: 2px solid #333333">
            <VaButton v-if="user.steam_username"
          ...
          <td style="border-left: 2px solid #333333">
            <VaButton v-if="user.github_username"
              :href="'https://steamcommunity.com/id/' + user.steam_username"
              target="_blank"
              color="#000000"
              borderColor="#ffffff"
